        ...
        Csv Munger O6co9
        ================
        Developer-friendly pipeline tool built to export data at every processing stage.
...
def _write_output(rows: list, path: Path, suffix: str) -> None:
    ...
    if suffix == ".csv" and rows:
        ...
        def build_parser() -> argparse.ArgumentParser:
            p = argparse.ArgumentParser(prog=APP_NAME, description="Developer-friendly pipeline tool built to export data at every processing stage.")
